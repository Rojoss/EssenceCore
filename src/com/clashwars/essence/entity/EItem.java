package com.clashwars.essence.entity;

import com.clashwars.essence.Essence;
import com.clashwars.essence.util.ItemParser;
...
public class EItem extends ItemStack {
    ...
    /**
     * Set the texture of the skull.
     * The texture url needs to be a valid code from http://textures.minecraft.net/
     * http://heads.freshcoal.com/maincollection.php for a list of skulls.
     * It should look like a code like this:
     ...
     * It can also be a direct link to the texture like: (Texture must be located on textures.minecraft.net)
     * http://textures.minecraft.net/texture/82d8ccac4d982bf3199761c1c74b9aa18e312ff5ca0a6e51b77a87abad610b
     */
    public EItem setTexture(String textureUrl) {
        setDurability((short)3);
        ItemMeta meta = getItemMeta();
        if (meta instanceof SkullMeta) {
            setItemMeta(Essence.inst().getNmsUtil().setSkullUrl(textureUrl, (SkullMeta)meta));
        }
        return this;
    }
