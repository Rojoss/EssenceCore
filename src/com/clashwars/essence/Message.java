...
public enum Message {
    ...
    INVALID_LOCATION("&4{0} &cis not a valid location!"),
    NOT_A_NUMBER("&4{0} &cis not a number!"),
    CANT_USE_RELATIVE_COORDS("&cYou can't use relative coordinates in the command line!"),
